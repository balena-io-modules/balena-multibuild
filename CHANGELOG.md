...
* Add build task option to use default docker platform behavior [Paul Jonathan Zoulin]
* Bump docker-progress version [Paul Jonathan Zoulin]
...
* Fix external image references when fetching the image manifest [Paulo Castro]
* Add Logger to BuildTask interface, use logger for multiarch warnings [Paulo Castro]

# v4.12.1
## (2021-09-17)

* Fix broken platform support which was comparing the wrong manifest media type [Paul Jonathan Zoulin]

# v4.12.0
## (2021-09-16)

* Determine when to use the docker 'platform' flag based on composition of Dockerfile and Docker api version. [toochevere]

# v4.11.1
## (2021-07-21)

* chore: Update @balena/lint and re-lint [Paulo Castro]
* Fix accidental 'it.only' left behind in test cases [Paulo Castro]

# v4.11.0
## (2021-05-05)

* Bypass Docker image build API 'platform' option if its value is 'none' [Paulo Castro]
* Remove dependency on docker-toolbelt, bump docker-progress [Paulo Castro]
